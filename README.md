...
Generate articulated 3D objects from a text prompt or a reference image.

<p align="center">
  <img alt="Eight objects generated by Articraft, rotating and moving their joints" src="assets/readme/reel.gif" width="100%">
</p>

Articraft asks a model to write Python with its 3D authoring SDK. It compiles the code,
checks the result, and exports a posable USDZ file.
